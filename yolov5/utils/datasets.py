...
def extract_boxes(path=DATASETS_DIR / 'coco128'):  # from yolov5.utils.datasets import *; extract_boxes()
...
def autosplit(path=DATASETS_DIR / 'coco128/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from yolov5.utils.datasets import *; autosplit()
    Arguments
...
def dataset_stats(path='coco128.yaml', autodownload=False, verbose=False, profile=False, hub=False):
    ...
    Usage1: from yolov5.utils.datasets import *; dataset_stats('coco128.yaml', autodownload=True)
    Usage2: from yolov5.utils.datasets import *; dataset_stats('path/to/coco128_with_yaml.zip')
    Arguments
